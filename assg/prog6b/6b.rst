...
will take the best combination of problems whose maximum values add to +8.
 ...
 2. Create a multi-purpose universal hacking tool.
      ...
      Among other things, it functions as a penetration testing utility (also
      known as hacking tool), since it can potentially be used to do anything
      you did in ``prog5b`` on any machine of your choice, and more; it can
      also gain root access to any filesystems and other devices on whatever
      machine boots it.  I will teach its use to anyone who can make one.
